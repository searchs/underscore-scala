...
//val oswald = new Cat("Oswald", colour="Black", food="Milk")
//val henderson = new Cat("Henderson", colour = "Ginger", food = "Chips")
//val quentin = new Cat("Quentin", colour = "Tabby and White", food = "Curry")
